...
interface TabBarProps {
    activeTab: 'students' | 'lessons' | 'exams' | 'grades'; // Tab types for the course details
    onTabChange: (tab: 'students' | 'lessons' | 'exams' | 'grades') => void; // Function to handle tab changes
    dynamicTabs: { label: string; value: 'students' | 'lessons' | 'exams' | 'grades' }[]; // Dynamic tab options
}
